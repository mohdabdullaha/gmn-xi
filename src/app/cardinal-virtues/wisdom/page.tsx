...
import { ArrowRight, BookOpen, Brain, Lightbulb, CheckCircle, MessageCircle, Scale } from 'lucide-react';
...
const subtopics = [
    {
        id: 'love-for-learning',
        title: 'Love for Learning',
        desc: 'A lifelong pursuit of knowledge that elevates the mind, soul, and society.',
        icon: <BookOpen size={28} className="text-white" />,
        path: '/cardinal-virtues/wisdom/love-for-learning',
    },
    {
        id: 'curiosity',
        title: 'Curiosity',
        desc: 'The desire to explore, question, and discover — the spark behind every great discovery.',
        icon: <Brain size={28} className="text-white" />,
        path: '/cardinal-virtues/wisdom/curiosity',
    },
    {
        id: 'creativity',
        title: 'Creativity',
        desc: 'The power to imagine, innovate, and express — transforming ideas into meaningful realities.',
        icon: <Lightbulb size={28} className="text-white" />,
        path: '/cardinal-virtues/wisdom/creativity',
    },
];
...
const Wisdom = () => {
    const data = content.wisdom as any;

    useEffect(() => { window.scrollTo(0, 0); }, []);

    return (
        <div className="min-h-screen flex flex-col bg-white">
            <Navbar pageTitle="Hikmah /Knowledge & Wisdom" />
            ...
            <main className="flex-grow">
                <PremiumHero 
                    ...
                    intro="The ability to govern and discipline oneself by reason, discerning the true good in every circumstance and choosing the right means to achieve it."
                />
                ...
                <section className="max-w-4xl mx-auto px-6 py-16">
                    <SectionHeading centered={false}>
                        The Concept
                        <br />
                        <span className="text-green">Knowledge & Wisdom</span>
                    </SectionHeading>
                ...
                <section className="bg-ice py-16 px-6">
                    <div className="max-w-4xl mx-auto">
                        <SectionHeading>
                            {data.quran.title.split('Wisdom')[0]}<span className="text-green">Wisdom</span>{data.quran.title.split('Wisdom')[1]}
                        </SectionHeading>
                ...
                <section className="max-w-4xl mx-auto px-6 py-16">
                    ...
                    <div className="mt-10 space-y-8">
                        {data.sunnah.insights.map((insight: any, idx: number) => (
                            <motion.div
                ...
                <section className="max-w-7xl mx-auto px-6 py-20 border-t border-gray-100 mt-10">
                    <div className="text-center mb-14">
                        ...
                        <p className="text-gray-500 mt-4 text-lg max-w-2xl mx-auto">
                            Dive deeper into the foundational pillars of Hikmah.
                        </p>
                    </div>
