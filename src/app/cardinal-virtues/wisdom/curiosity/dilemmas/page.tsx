...
const DilemmasCuriosity = () => {
    const data = content.curiosity.dilemmas as any;
        ...
        <div className="min-h-screen flex flex-col bg-white">
            ...
            <main className="flex-grow">
                <PremiumHero 
                    ...
                    intro="Ethical Challenges in Curiosity"
                />
                ...
                <section className="max-w-7xl mx-auto px-6 py-16 text-center">
                    ...
                    <NavGrid excludeId="curiosity-dilemmas" section="curiosity" />
                </section>
            </main>
...
export default DilemmasCuriosity;
