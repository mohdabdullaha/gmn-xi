...
const LoveForLearning = () => {
    const data = content.loveForLearning.concept as any;

    useEffect(() => { window.scrollTo(0, 0); }, []);

    return (
        <div className="min-h-screen flex flex-col bg-white">
            <Navbar pageTitle="Love for Learning" />
            ...
            <main className="flex-grow">
                <PremiumHero 
                    ...
                    intro="Inspiring hearts to seek knowledge for life."
                />
                ...
                <section className="max-w-7xl mx-auto px-6 py-16">
                    <div className="max-w-4xl mx-auto text-left space-y-8">
                        <SectionHeading centered={false}>
                            The Concept
                            <br />
                            <span className="text-green">Love for Learning</span>
                        </SectionHeading>
                    ...
                    <NavGrid excludeId="love-for-learning" section="loveForLearning" />
                </section>
            </main>
...
export default LoveForLearning;
