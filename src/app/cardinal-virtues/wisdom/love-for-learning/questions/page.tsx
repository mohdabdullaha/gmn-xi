...
const QuestionsLFL = () => {
    const data = content.loveForLearning.questions as any;
        ...
        <div className="min-h-screen flex flex-col bg-white">
            ...
            <main className="flex-grow">
                <PremiumHero 
                    ...
                    intro="Deepening Your Knowledge"
                />
                ...
                <section className="max-w-7xl mx-auto px-6 py-16 text-center">
                    ...
                    <NavGrid excludeId="lfl-questions" section="loveForLearning" />
                </section>
            </main>
