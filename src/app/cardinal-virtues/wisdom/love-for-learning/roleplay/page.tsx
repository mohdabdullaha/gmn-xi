...
const RolePlayLFL = () => {
    const data = content.loveForLearning.roleplay as any;
        ...
        <div className="min-h-screen flex flex-col bg-white">
            ...
            <main className="flex-grow">
                <PremiumHero 
                    ...
                    intro="Bringing Learning to Life"
                />
                ...
                <section className="max-w-7xl mx-auto px-6 py-16 text-center">
                    ...
                    <NavGrid excludeId="lfl-roleplay" section="loveForLearning" />
                </section>
            </main>
