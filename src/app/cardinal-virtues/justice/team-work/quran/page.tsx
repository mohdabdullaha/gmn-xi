...
const QuranTeamWork = () => {
    const data = content.teamWork.quran as any;
        ...
        <div className="min-h-screen flex flex-col bg-white">
            ...
            <main className="flex-grow">
                <PremiumHero 
                    ...
                    intro="The Divine Wisdom on Team Work"
                />

                <section className="max-w-7xl mx-auto px-6 py-16 text-center">
                    <div className="max-w-4xl mx-auto space-y-12">
                        <SectionHeading>The Divine Wisdom on <span className="text-green">Team Work</span></SectionHeading>
                    ...
                    <NavGrid excludeId="quran" section="teamWork" />
                </section>
            </main>
