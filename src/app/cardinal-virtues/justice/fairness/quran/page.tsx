...
const QuranFairness = () => {
    const data = content.fairness.quran as any;
        ...
        <div className="min-h-screen flex flex-col bg-white">
            ...
            <main className="flex-grow">
                <PremiumHero 
                    ...
                    intro="The Divine Wisdom on Fairness"
                />

                <section className="max-w-7xl mx-auto px-6 py-16 text-center">
                    <div className="max-w-4xl mx-auto space-y-12">
                        <SectionHeading>The Divine Wisdom on <span className="text-green">Fairness</span></SectionHeading>
                    ...
                    <NavGrid excludeId="quran" section="fairness" />
                </section>
            </main>
