...
const Fairness = () => {
    const data = content.fairness.concept as any;
            ...
            <main className="flex-grow">
                ...
                <section className="max-w-7xl mx-auto px-6 py-16">
                    <div className="max-w-4xl mx-auto text-left space-y-8">
                        <SectionHeading centered={false}>The Significance of <span className="text-green">Fairness</span></SectionHeading>
                    ...
                    <NavGrid excludeId="fairness" section="fairness" />
                </section>
            </main>
