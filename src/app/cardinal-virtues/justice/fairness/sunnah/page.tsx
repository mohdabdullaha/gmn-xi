...
const SunnahFairness = () => {
    const data = content.fairness.sunnah as any;
        ...
        <div className="min-h-screen flex flex-col bg-white">
            ...
            <main className="flex-grow">
                <PremiumHero 
                    ...
                    intro="Prophetic Guidance on Fairness"
                />

                <section className="max-w-7xl mx-auto px-6 py-16 text-center">
                    <div className="max-w-5xl mx-auto space-y-12">
                        <SectionHeading>Prophetic Guidance on <span className="text-green">Fairness</span></SectionHeading>
                    ...
                    <NavGrid excludeId="sunnah" section="fairness" />
                </section>
            </main>
