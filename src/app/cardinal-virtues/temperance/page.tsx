...
import { ArrowRight, Heart, Lock, Leaf } from 'lucide-react';

const heroImg = '/img.jpg';
const subtopics = [
    { id: 'self-regulation', title: 'Self-Regulation', desc: "Mastery over one's impulses, emotions, and desires through discipline.", icon: <Heart size={28} className="text-white" />, path: '/cardinal-virtues/temperance/self-regulation' },
    { id: 'modesty', title: 'Modesty', desc: 'Humility in dress, speech, and conduct — a shield of inner dignity.', icon: <Lock size={28} className="text-white" />, path: '/cardinal-virtues/temperance/modesty' },
    { id: 'chastity', title: 'Chastity', desc: 'Purity of heart and body — the foundation of a dignified and honorable life.', icon: <Leaf size={28} className="text-white" />, path: '/cardinal-virtues/temperance/chastity' },
];
...
const Temperance = () => {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-white">
            <Navbar pageTitle="Iffah / Temperance" />
            <main className="flex-grow">
                <PremiumHero 
                    ...
                    intro="The moral virtue that moderates the attraction of pleasures and provides balance in the use of created goods."
                />
                <section className="max-w-7xl mx-auto px-6 py-20">
                    <div className="text-center mb-14">
                        <SectionHeading centered={true}>Explore <span className="text-green">Temperance</span> Topics</SectionHeading>
                ...
                <section className="bg-navy py-14 px-6 text-center">
                    <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="max-w-3xl mx-auto">
                        ...
                        <p className="text-white text-lg md:text-xl font-medium leading-relaxed italic">The strong is not the one who overcomes the people by his strength, but the strong is the one who controls himself while in anger.</p>
                        <p className="text-gold/60 text-xs mt-3 tracking-widest">Sahih al-Bukhari</p>
