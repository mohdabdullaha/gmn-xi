...
const SelfRegulation = () => {
    const data = content.selfRegulation.concept as any;
            ...
            <main className="flex-grow">
                ...
                <section className="max-w-7xl mx-auto px-6 py-16">
                    <div className="max-w-4xl mx-auto text-left space-y-8">
                        <SectionHeading centered={false}>The Significance of <span className="text-green">Self-Regulation</span></SectionHeading>
                        <motion.p
                            initial={{ opacity: 0 }}
                    ...
                    <NavGrid excludeId="selfRegulation" section="selfRegulation" />
                </section>
            </main>
