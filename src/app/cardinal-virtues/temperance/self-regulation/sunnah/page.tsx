...
const SunnahSelfRegulation = () => {
    const data = content.selfRegulation.sunnah as any;
        ...
        <div className="min-h-screen flex flex-col bg-white">
            ...
            <main className="flex-grow">
                <PremiumHero 
                    ...
                    intro="Prophetic Guidance on Self-Regulation"
                />

                <section className="max-w-7xl mx-auto px-6 py-16 text-center">
                    <div className="max-w-5xl mx-auto space-y-12">

                        <SectionHeading>Prophetic Guidance on <span className="text-green">Self-Regulation</span></SectionHeading>
                    ...
                    <NavGrid excludeId="sunnah" section="selfRegulation" />
                </section>
            </main>
...
export default SunnahSelfRegulation;
